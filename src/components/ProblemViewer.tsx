...
export const ProblemViewer: React.FC<ProblemViewerProps> = ({ problem }) => {
	...
	useEffect(() => {
		...
		const codeTags = document.querySelectorAll(
			"#lone"
		) as NodeListOf<HTMLElement>;

		preTags.forEach((tag) => {
			tag.classList.add("font-jetbrainsMono");
		...
		<div className="h-full flex flex-col">
			...
			<div className="flex-1 overflow-y-auto p-6">
					...
					<>
						<div className="mb-4">
							...
							<div className="flex items-center gap-2 mt-2">
								<span
									className={`px-2 py-1 text-xs rounded ${getDifficultyBadgeColor(
										problem.difficulty
									)}`}
								>
									{problem.difficulty}
									...
									{problem.examples.map((example, index) => (
										...
										>
											...
											<div className="bg-gray-50 p-3 rounded-md mb-2">
												...
												<div className="mb-1 font-jetbrainsMono">
				...
				{activeTab === "solution" && (
					<div className="p-4">
						<p className="text-gray-500">
							Official solutions will be available after you solve
							the problem.
						</p>
					</div>
				)}
				...
				{activeTab === "discussion" && (
					<div className="p-4">
						<p className="text-gray-500">
							Community discussions will be available in the full
							version.
						</p>
					</div>
				)}
